    ...
    <div className="min-h-screen bg-white flex font-sans">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 md:p-16">
        <div className="w-full max-w-md space-y-5 text-left">
          ...
          <button
            type="button"
            className="w-full py-3 bg-[#e8f5e9]/60 hover:bg-[#e8f5e9] text-gray-700 font-semibold rounded-[8px] text-xs flex items-center justify-center gap-3 border border-emerald-100 transition-colors cursor-pointer"
          >
